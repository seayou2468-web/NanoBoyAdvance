...
static void ARMul_ResetMPCoreCP15Registers(ARMul_State* state) {
	/* c0 */
	state->CP15[CP15_MAIN_ID] = 0x410FB024;
	state->CP15[CP15_TLB_TYPE] = 0x00000800;
	state->CP15[CP15_PROCESSOR_FEATURE_0] = 0x00000111;
	state->CP15[CP15_PROCESSOR_FEATURE_1] = 0x00000001;
	state->CP15[CP15_DEBUG_FEATURE_0] = 0x00000002;
	state->CP15[CP15_MEMORY_MODEL_FEATURE_0] = 0x01100103;
	state->CP15[CP15_MEMORY_MODEL_FEATURE_1] = 0x10020302;
	state->CP15[CP15_MEMORY_MODEL_FEATURE_2] = 0x01222000;
	state->CP15[CP15_MEMORY_MODEL_FEATURE_3] = 0x00000000;
	state->CP15[CP15_ISA_FEATURE_0] = 0x00100011;
	state->CP15[CP15_ISA_FEATURE_1] = 0x12002111;
	state->CP15[CP15_ISA_FEATURE_2] = 0x11221011;
	state->CP15[CP15_ISA_FEATURE_3] = 0x01102131;
	state->CP15[CP15_ISA_FEATURE_4] = 0x00000141;
	state->CP15[CP15_CPU_ID] = 0x00000000;

	/* c1 */
	state->CP15[CP15_CONTROL] = 0x00054078;
	state->CP15[CP15_AUXILIARY_CONTROL] = 0x0000000F;
	state->CP15[CP15_COPROCESSOR_ACCESS_CONTROL] = 0x00000000;

	/* c2 */
	state->CP15[CP15_TRANSLATION_BASE_TABLE_0] = 0x00000000;
	state->CP15[CP15_TRANSLATION_BASE_TABLE_1] = 0x00000000;
	state->CP15[CP15_TRANSLATION_BASE_CONTROL] = 0x00000000;

	/* c3 */
	state->CP15[CP15_DOMAIN_ACCESS_CONTROL] = 0x00000000;

	/* c5/c6 */
	state->CP15[CP15_FAULT_STATUS] = 0x00000000;
	state->CP15[CP15_INSTR_FAULT_STATUS] = 0x00000000;
	state->CP15[CP15_FAULT_ADDRESS] = 0x00000000;
	state->CP15[CP15_WFAR] = 0x00000000;

	/* c7 */
	state->CP15[CP15_PHYS_ADDRESS] = 0x00000000;

	/* c9 */
	state->CP15[CP15_DATA_CACHE_LOCKDOWN] = 0xFFFFFFF0;

	/* c10 */
	state->CP15[CP15_TLB_LOCKDOWN] = 0x00000000;
	state->CP15[CP15_PRIMARY_REGION_REMAP] = 0x00098AA4;
	state->CP15[CP15_NORMAL_REGION_REMAP] = 0x44E048E0;

	/* c13 */
	state->CP15[CP15_PID] = 0x00000000;
	state->CP15[CP15_CONTEXT_ID] = 0x00000000;
	state->CP15[CP15_THREAD_UPRW] = 0x00000000;
	state->CP15[CP15_THREAD_URO] = 0x00000000;
	state->CP15[CP15_THREAD_PRW] = 0x00000000;

	/* c15 */
	state->CP15[CP15_PERFORMANCE_MONITOR_CONTROL] = 0x00000000;
	state->CP15[CP15_CYCLE_COUNTER] = 0x00000000;
	state->CP15[CP15_COUNT_0] = 0x00000000;
	state->CP15[CP15_COUNT_1] = 0x00000000;
	state->CP15[CP15_MAIN_TLB_LOCKDOWN_VIRT_ADDRESS] = 0x00000000;
	state->CP15[CP15_MAIN_TLB_LOCKDOWN_PHYS_ADDRESS] = 0x00000000;
	state->CP15[CP15_MAIN_TLB_LOCKDOWN_ATTRIBUTE] = 0x00000000;
	state->CP15[CP15_TLB_DEBUG_CONTROL] = 0x00000000;
}
...
ARMul_Reset (ARMul_State * state)
{
	...
	mmu_reset (state);
	ARMul_ResetMPCoreCP15Registers(state);
