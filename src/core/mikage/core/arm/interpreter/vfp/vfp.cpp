...
VFPInit (ARMul_State *state)
{
	...
	state->VFP[VFP_OFFSET(VFP_FPINST)] = 0xEE000A00;
	state->VFP[VFP_OFFSET(VFP_FPINST2)] = 0;
	state->VFP[VFP_OFFSET(VFP_MVFR0)] = 0x11111111;
	state->VFP[VFP_OFFSET(VFP_MVFR1)] = 0;
