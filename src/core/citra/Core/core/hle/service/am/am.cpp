...
#include "../../../../include/core/hle/service/am/am_app.h"
#include "../../../../include/core/hle/service/am/am_net.h"
#include "../../../../include/core/hle/service/am/am_sys.h"
#include "../../../../include/core/hle/service/am/am_u.h"
...
//Manic修改 获取待安装的CIA的title
std::string GetCIATitleID(const std::string& path) {
    FileSys::CIAContainer container;
    if (container.Load(path) == Loader::ResultStatus::Success) {
        return fmt::format("{:016X}", container.GetTitleMetadata().GetTitleID());
    }
    return "";
}
