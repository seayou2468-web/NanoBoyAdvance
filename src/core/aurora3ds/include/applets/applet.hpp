...
namespace Applets {
	...
	class AppletBase {
	  ...
	  public:
		...
		virtual ResultCode::HorizonResult start(const MemoryBlock* sharedMem, const std::vector<u8>& parameters, u32 appID) = 0;
		// Transfer parameters from application -> applet
		virtual ResultCode::HorizonResult receiveParameter(const Parameter& parameter) = 0;
