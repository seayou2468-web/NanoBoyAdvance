...
class APTService {
	...
	void getAppletManInfo(u32 messagePointer);
	void countRegisteredApplet(u32 messagePointer);
	void getAttribute(u32 messagePointer);
	void getAppletInfo(u32 messagePointer);
	void getProgramID(u32 messagePointer);
	void getScreenCapturePostPermission(u32 messagePointer);
	void getStartupArgument(u32 messagePointer);
	void getSharedFont(u32 messagePointer);
	void getWirelessRebootInfo(u32 messagePointer);
	void getApplicationRunningMode(u32 messagePointer);
	void isStandardMemoryLayout(u32 messagePointer);
	void isTitleAllowed(u32 messagePointer);
	...
	void prepareToStartApplication(u32 messagePointer);
	void prepareToCloseApplication(u32 messagePointer);
	void closeApplication(u32 messagePointer);
	void prepareToJumpToHomeMenu(u32 messagePointer);
	void jumpToHomeMenu(u32 messagePointer);
	void prepareToLeaveHomeMenu(u32 messagePointer);
	void leaveHomeMenu(u32 messagePointer);
